...
def get_input_args():
    ...
    parser.add_argument('--dir', default='pet_images', help='images folder')
    parser.add_argument('--arch', default='vgg', help='CNN Model Architecture', choices=['resnet', 'alexnet', 'vgg'])
